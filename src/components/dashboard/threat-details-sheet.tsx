...
import { Bot, User, HardDrive, Globe, AlertTriangle, Clock, Info, ArrowRight } from 'lucide-react';
        ...
        <Tabs defaultValue="overview">
          ...
          <TabsContent value="overview" className="mt-4 space-y-6">
            ...
            <div className="space-y-3">
                ...
                <Card className="text-center p-6 flex flex-col items-center bg-card/50 border-dashed">
                    ...
                    For a deeper, AI-powered analysis of behavioral patterns and event correlation, proceed to the Analysis page.
                    </CardDescription>
                    <Button asChild>
          ...
          <TabsContent value="behavior" className="mt-4">
            {threat.behavioralBaseline ? (
                ...
                <p className='text-muted-foreground text-center p-4'>No behavioral baseline data available.</p>
            )}
          </TabsContent>
